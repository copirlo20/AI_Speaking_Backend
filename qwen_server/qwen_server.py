...
# Trích xuất JSON từ văn bản trả về của mô hình
def extract_json_from_text(text):
    try:
        ...
        pass
    # Phương án dự phòng: trích xuất điểm số và phản hồi thủ công.
...
"""
Chấm điểm câu trả lời của thí sinh dựa trên văn bản chuyển ngữ và các câu trả lời mẫu.
...
{"score": <0-10>, "feedback": "<nhận xét chi tiết bằng tiếng Việt, có so sánh với mẫu>"}"""
        # Tạo phần tham khảo câu trả lời mẫu
        sample_context = ""
        if sample_answers:
